...
const Point2D TARGET = Point2D(31, 39);
...
size_t get_shortest_distance(Point2D target) {
    set<Point2D> memo;
...
int main() {
    ...
    auto output = get_shortest_distance(TARGET);
    cout << "The min distance required is " << output << endl;
}