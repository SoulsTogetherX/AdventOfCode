...
const string TARGET_PASSWORD = "fbgdceah";
...
string brute_force(vector<Instruction> instructions, string target) {
    string perm, current;
...
string process_file() {
    ...
    return brute_force(instructions, target);
}


int main() {
    auto output = process_file();
    cout << "The unscrambled password " << output << endl;
}